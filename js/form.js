...
$( document ).ready ( function ( ) { 
  ...
  $( '#mainForm' ).submit ( function ( event ) {
    ...
    var inputs = {
            ...
            'blast_task' : $( '#blast-task' ).val(),
            'blast_scoring' : $( '#blast-scoring' ).val(),
            'blast_ungapped' : $( '#blast-ungapped' ).val(),
            'blast_xdrop_gap' : $( '#blast-xdropGap' ).val(),
            'blast_xdrop_gap_final' : $( '#blast-xdropGapFinal' ).val(),
