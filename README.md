...
![Telomere annotation parameters input fields in the web application interface.](https://github.com/JasperBraun/SDRAP/blob/master/docs/images/telomere_annotation_parameters.png?s=100)
